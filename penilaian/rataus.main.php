...
<head>
    ...
    <title>Rata-rata Nilai Setiap Siswa</title>
    <!-- Tailwind CSS CDN -->
    ...
    function carisiswa() {
        document.getElementById('footer_frame').src = "rataus.blank.php";
    ...
    function acceptSiswa(nis, nama, flag) {
        ...
        document.getElementById('footer_frame').src = "../penilaian/rataus.footer.main.php?nis="+nis;
    }
    </script>
</head>
    ...
    <div class="w-full h-[calc(100vh-3rem)] bg-slate-50 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-green-800/30 p-6 md:p-10 flex flex-col">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div class="flex items-center gap-4 bg-white p-4 rounded-3xl border border-green-100 shadow-sm flex-1">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">RATA-RATA NILAI SISWA</h1>
                </div>
            </div>
        ...
        <div class="bg-white p-5 rounded-3xl border border-slate-100 shadow-sm mb-6 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2.5 text-slate-400 text-[10px] font-bold uppercase tracking-widest italic">
                <i class="fa-solid fa-info-circle text-emerald-600"></i> Cari siswa untuk kalkulasi rata-rata nilai
            </div>
        </div>

        <!-- Content Area -->
        <div class="flex-1 bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden relative">
            <iframe name="footer" id="footer_frame" src="rataus.blank.php" class="w-full h-full border-none"></iframe>
        </div>

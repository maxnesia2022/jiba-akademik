...
<head>
    ...
    <title>Legger Rapor Per Kelas</title>
    <!-- Tailwind CSS CDN -->
    ...
    function change_dept() {
        ...
        document.location.href = "legger.kelas.php?departemen="+departemen;
    }

    function change_ta() {
        var departemen = document.getElementById("departemen").value;
        var tahunajaran = document.getElementById("tahunajaran").value;
        document.location.href = "legger.kelas.php?departemen="+departemen+"&tahunajaran="+tahunajaran;
    }
    ...
    function change_tingkat() {
        ...
        document.location.href = "legger.kelas.php?departemen="+departemen+"&tahunajaran="+tahunajaran+"&tingkat="+tingkat;
    }
    ...
    function change_kelas() {
        ...
        document.location.href = "legger.kelas.php?departemen="+departemen+"&tahunajaran="+tahunajaran+"&tingkat="+tingkat+"&kelas="+kelas;
    }
    ...
    function change_semester() {
        ...
        document.location.href = "legger.kelas.php?departemen="+departemen+"&tahunajaran="+tahunajaran+"&tingkat="+tingkat+"&kelas="+kelas+"&semester="+semester;
    }
    ...
    function show() {
        ...
        document.getElementById('footer_frame').src = "legger.kelas.content.php?idkelas="+kelas+"&idsemester="+semester+"&idpelajaran="+pelajaran;
    }
...
<body class="bg-green-950 text-slate-800 min-h-screen p-4 md:p-6 select-none overflow-x-hidden" onload="document.getElementById('departemen').focus()">
    ...
    <div class="w-full h-[calc(100vh-3rem)] bg-slate-50 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-green-800/30 p-6 md:p-10 flex flex-col">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div class="flex items-center gap-4 bg-white p-4 rounded-3xl border border-green-100 shadow-sm flex-1">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">LEGGER RAPOR PER KELAS</h1>
                </div>
            </div>
            ...
            <div class="bg-slate-100 px-5 py-3 rounded-2xl border border-slate-200 self-start md:self-center text-xs flex items-center gap-2">
                ...
                <span class="text-slate-600 font-medium">Legger Kelas</span>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-[2.5rem] border border-slate-100 shadow-sm mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="relative">
                            <select name="kelas" id="kelas" onChange="change_kelas()" class="appearance-none bg-slate-50 border border-slate-200 text-slate-800 text-xs font-bold rounded-xl focus:ring-emerald-500 block w-32 pl-3 pr-8 py-2.5 shadow-sm transition-colors cursor-pointer">
                                <?
            ...
            <div class="flex items-center justify-end gap-2.5 mt-4">
                <button id="tabel" onClick="show()" class="flex items-center gap-2 bg-emerald-900 hover:bg-emerald-800 text-white font-bold text-xs py-2.5 px-8 rounded-xl shadow-md transition-all duration-200 active:scale-95">
                    <i class="fa-solid fa-magnifying-glass"></i> Tampilkan Legger
                </button>
            </div>
        </div>
        ...
        <div class="flex-1 bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden relative">
            <iframe name="footer" id="footer_frame" src="legger.kelas.blank.php" class="w-full h-full border-none"></iframe>
        </div>

    ...
    <div class="w-full min-h-[calc(100vh-3rem)] bg-slate-50 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-green-800/30 p-6 md:p-10">
        ...
        <div class="max-w-6xl mx-auto mb-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div class="flex items-center gap-4 bg-white p-5 rounded-[2rem] border border-green-100 shadow-md shadow-green-500/5">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-extrabold text-slate-900 tracking-tight">KESISWAAN</h1>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <div onClick="alert('Gunakan menu Tahun Ajaran di bagian referensi \nuntuk mendata Tahun Ajaran');" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-amber-500/30 hover:shadow-2xl hover:shadow-amber-500/10 transition-all duration-300 flex flex-col justify-between h-52 relative overflow-hidden cursor-pointer">
                    ...
                    <div class="z-10">
                        ...
                        <p class="text-xs text-slate-500 line-clamp-2">Pemberitahuan konfigurasi agenda tahun ajaran kesiswaan aktif.</p>
                    </div>
                ...
                <!-- Pendataan Siswa -->
                <a href="siswa/siswa_main.php" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 flex flex-col justify-between h-52 relative overflow-hidden">
                    ...
                    <div class="z-10">
                        ...
                        <h3 class="font-bold text-slate-800 text-base mb-1">Data Siswa</h3>
                        <p class="text-xs text-slate-500 line-clamp-2">Manajemen registrasi, mutasi kelas, dan biodata induk lengkap siswa.</p>
                    </div>
                ...
                <!-- Pencarian Siswa -->
                <a href="siswa/siswa_cari_main.php" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 flex flex-col justify-between h-52 relative overflow-hidden">
                    <div class="absolute -right-4 -top-4 w-28 h-28 bg-emerald-50/40 rounded-[40%_60%_70%_30%] group-hover:scale-110 transition-transform duration-300"></div>
                    <div class="z-10">
                        <div class="w-12 h-12 bg-emerald-900 text-white rounded-[1.25rem] flex items-center justify-center text-xl mb-4 group-hover:scale-105 transition-all shadow-md">
                            <i class="fa-solid fa-magnifying-glass"></i>
                        </div>
                        <h3 class="font-bold text-slate-800 text-base mb-1">Pencarian Siswa</h3>
                        <p class="text-xs text-slate-500 line-clamp-2">Cari profile siswa berdasarkan NIS, nama, kelas, atau angkatan.</p>
                    </div>
                    <span class="text-xs font-semibold text-emerald-800 flex items-center gap-1 group-hover:translate-x-1 transition-transform duration-200">
                        Masuk Modul <i class="fa-solid fa-arrow-right text-[10px]"></i>
                    </span>
                ...
                <!-- Pindah Kelas -->
                <a href="siswa/siswa_pindah_main.php" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 flex flex-col justify-between h-52 relative overflow-hidden">
                    <div class="absolute -right-4 -top-4 w-28 h-28 bg-emerald-50/40 rounded-[40%_60%_70%_30%] group-hover:scale-110 transition-transform duration-300"></div>
                    <div class="z-10">
                        <div class="w-12 h-12 bg-emerald-900 text-white rounded-[1.25rem] flex items-center justify-center text-xl mb-4 group-hover:scale-105 transition-all shadow-md">
                            <i class="fa-solid fa-shuffle"></i>
                        </div>
                        <h3 class="font-bold text-slate-800 text-base mb-1">Pindah Kelas</h3>
                        <p class="text-xs text-slate-500 line-clamp-2">Kelola mutasi kelas paralel dan perpindahan siswa antarkelas.</p>
                    </div>
                    <span class="text-xs font-semibold text-emerald-800 flex items-center gap-1 group-hover:translate-x-1 transition-transform duration-200">
                        Masuk Modul <i class="fa-solid fa-arrow-right text-[10px]"></i>
                    </span>
                ...
                <!-- Statistik Kesiswaan -->
                <a href="siswa/siswa_statistik_main.php" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-2xl hover:shadow-green-500/10 transition-all duration-300 flex flex-col justify-between h-52 relative overflow-hidden sm:col-span-2">
                    <div class="absolute -right-4 -top-4 w-28 h-28 bg-emerald-50/40 rounded-[40%_60%_70%_30%] group-hover:scale-110 transition-transform duration-300"></div>
                    <div class="z-10">
                        <div class="w-12 h-12 bg-emerald-900 text-white rounded-[1.25rem] flex items-center justify-center text-xl mb-4 group-hover:scale-105 transition-all shadow-md">
                            <i class="fa-solid fa-chart-line"></i>
                        </div>
                        <h3 class="font-bold text-slate-800 text-base mb-1">Statistik Kesiswaan</h3>
                        <p class="text-xs text-slate-500 line-clamp-2">Visualisasi data demografi siswa, total pertumbuhan, dan sebaran kelas.</p>
                    </div>
                    <span class="text-xs font-semibold text-emerald-800 flex items-center gap-1 group-hover:translate-x-1 transition-transform duration-200">
                        Masuk Modul <i class="fa-solid fa-arrow-right text-[10px]"></i>
                    </span>
            ...
            <div class="flex flex-col gap-6">
                <!-- PIN Siswa -->
                <a href="siswa/pin_main.php" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center">
                    ...
                    <h3 class="font-extrabold text-slate-800 text-sm mb-1">PIN Siswa</h3>
                    <p class="text-xs text-slate-400">Generate, re-issue, dan kelola PIN keamanan otentikasi portal siswa.</p>
                </a>

                <!-- Kolom Tambahan Data -->
                <a href="referensi/tambahandata.php?from=Kesiswaan" class="group bg-white p-6 rounded-[2rem] border border-slate-100 hover:border-green-500/30 hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center">
                    <div class="w-16 h-16 bg-emerald-900 text-white rounded-[1.5rem] flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-emerald-900/30">
                        <i class="fa-solid fa-circle-plus"></i>
                    </div>
                    <h3 class="font-extrabold text-slate-800 text-sm mb-1">Kolom Tambahan Data</h3>
                    <p class="text-xs text-slate-400">Kostumisasi data penunjang (hobi, prestasi, dsb) di luar form utama.</p>
                </a>
            </div>
        </div>

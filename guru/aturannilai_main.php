...
<head>
    ...
    function caripegawai() {
        document.getElementById('menu_frame').src = "../blank2.php";
        document.getElementById('content_frame').src = "blank_nilai.php";
    ...
    function acceptPegawai(nip, nama, flag) {
        ...
        document.getElementById('menu_frame').src = "aturannilai_menu.php?nip="+nip+"&nama="+nama;
        document.getElementById('content_frame').src = "blank_nilai.php";
    }
    </script>
    <style>
        ...
        <div class="flex-1 flex gap-6 overflow-hidden">
            ...
            <div class="w-80 flex flex-col gap-6 h-full">
                ...
                <div class="flex-1 bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden">
                    <iframe name="aturan_nilai_footer" id="menu_frame" src="../blank2.php" class="w-full h-full border-none"></iframe>
                </div>
            </div>

            <!-- Content Area Iframe -->
            <div class="flex-1 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden relative">
                <iframe name="aturan_nilai_content" id="content_frame" src="blank_nilai.php" class="w-full h-full border-none"></iframe>
            </div>
        </div>
    </div>
</body>

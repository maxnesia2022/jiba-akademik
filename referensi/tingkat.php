...
<head>
    ...
    function tambah() {
        ...
        window.open('tingkat_add.php?departemen='+departemen, 'TambahTingkat','width=500,height=310,resizable=1,scrollbars=1');
    }
    ...
    function setaktif(replid, aktif) {
        var departemen = document.getElementById('departemen').value;
        var msg = (aktif == 1) ? "Non-aktifkan tingkat ini?" : "Aktifkan tingkat ini?";
    ...
    function cetak() {
        var departemen = document.getElementById('departemen').value;
        window.open('tingkat_cetak.php?departemen='+departemen, 'CetakTingkat','width=790,height=650,resizable=1,scrollbars=1');
    }
    </script>
    <style>
    ...
    <div class="w-full min-h-[calc(100vh-3rem)] bg-slate-50 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl border border-emerald-800/30 p-6 md:p-10">
        ...
        <?php } else { ?>
            ...
            <div class="bg-white rounded-3xl border border-slate-100 shadow-md p-12 text-center max-w-xl mx-auto mt-12">
                ...
                <p class="text-xs text-slate-500 mb-6">Silakan buat data tingkat baru.</p>
                <?php if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
